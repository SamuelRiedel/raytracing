  ...
  if ((sphere->transparency > 0 || sphere->reflection > 0) &&
    ...
    for (unsigned i = 0; i < num_spheres; ++i) {
      if (spheres[i].emissionColor.x > 0) {
        ...
        transmission *= std::max(float(0), vec_dot(nhit, lightDirection));
...
int main(int argc, char **argv) {
  ...
  spheres[0] = { .center = VEC3_xyz(0.0, -10004, -20),
                 .radius = 10000,
                 .radius2 = 10000 * 10000,
                 ...
                 .transparency = 0,
                 .reflection = 0 };
  spheres[1] = { .center = VEC3_xyz(0.0, 0, -20),
                 .radius = 4,
                 .radius2 = 4 * 4,
                 ...
                 .transparency = 0,
                 .reflection = 1 };
  spheres[2] = { .center = VEC3_xyz(5.0, -1, -15),
                 .radius = 2,
                 .radius2 = 2 * 2,
                 ...
                 .transparency = 0,
                 .reflection = 0 };
  spheres[3] = { .center = VEC3_xyz(5.0, 0, -25),
                 .radius = 3,
                 .radius2 = 3 * 3,
                 ...
                 .transparency = 0,
                 .reflection = 1 };
  spheres[4] = { .center = VEC3_xyz(-5.5, 0, -15),
                 .radius = 3,
                 .radius2 = 3 * 3,
                 ...
                 .reflection = 1 };
  // light
  spheres[5] = { .center = VEC3_xyz(0.0, 20, -30),
                 .radius = 3,
                 .radius2 = 3 * 3,
