...
//[/comment]
Vec3f trace(const Vec3f &rayorig, const Vec3f &raydir, const Sphere *spheres,
  ...
  if ((sphere->transparency > 0 || sphere->reflection > 0) &&
    ...
    refldir.normalize();
    Vec3f reflection =
        trace(phit + nhit * bias, refldir, spheres, num_spheres, depth + 1);
    Vec3f refraction = 0;
    ...
    if (sphere->transparency) {
      ...
      refrdir.normalize();
      refraction =
          trace(phit - nhit * bias, refrdir, spheres, num_spheres, depth + 1);
    }
